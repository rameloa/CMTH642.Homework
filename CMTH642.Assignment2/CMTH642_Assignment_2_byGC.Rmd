...
# (illustrations do not improve students' ability to retell article (p > 0.05))
```
...
# If, above, you decided that cylinders were interval and could be ranked (V8 > V6 > V4, etc), which doesn't make sense to me, you would pass the cor function an argument method="spearman"
```

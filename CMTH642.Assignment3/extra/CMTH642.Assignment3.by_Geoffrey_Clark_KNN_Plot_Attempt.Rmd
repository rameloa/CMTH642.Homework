...
# 
# I adapted my code as much as possible from the examples and discussion on Stack Overflow but in the end
# had to settle for a relatively straightforward cluster plot based on kNN algorithm.
# I think this could be improved with dimensionality reduction: There are 12 dimenstions in this 
# data set so reducing them to two or three principal components would perhaps make for a better
# visual and also contribute in general to the analysis. 
